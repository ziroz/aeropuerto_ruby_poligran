...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { address: @passenger.address, email: @passenger.email, identification: @passenger.identification, name: @passenger.name, phone: @passenger.phone }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { address: @passenger.address, email: @passenger.email, identification: @passenger.identification, name: @passenger.name, phone: @passenger.phone }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
